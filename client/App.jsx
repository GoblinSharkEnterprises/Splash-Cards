...
const App = () => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path='/createset' element={<CreateSet currentUser={currentUser}/>} />
      <Route path='/sets/set/:id' element={<ViewThisSet currentUser={currentUser}/>} />
      <Route path='/testSet/:id' element={<TestSet currentUser={currentUser}/>} />
